...
namespace WorldWind
{
	...
	public class PlaceFinder : System.Windows.Forms.Form
	{
        ...
        private CheckBox cbSearchInView;
        private TabPage tabPageGM;
        private Button button9;
        private EnterTextBox enterTextBox3;
        private PictureBox pictureBox1;
        private PictureBox pictureBox8;
        private Button button10;
        private EnterTextBox enterTextBox4;
        private Button button11;
        private PictureBox pictureBox9;
        private EnterTextBox enterTextBox5;
        private EnterTextBox GMenterTextBox;
        private Button gmSearch;
        private PictureBox pictureBoxGM;
		...
		public PlaceFinder(WorldWind.WorldWindow ww)
		{
			...
			try
			{
                ...
                Image gmImage = Image.FromFile(
                    Path.Combine(Path.GetDirectoryName(Application.ExecutablePath), "Plugins\\PlaceFinder\\gmearth.png"));

                pictureBoxGM.Size = new Size(gmImage.Width, gmImage.Height);

                pictureBoxGM.Image = gmImage;
			}
			catch{}
		...
		private void InitializeComponent()
		{
            ...
            this.cbSearchInView = new System.Windows.Forms.CheckBox();
            ...
            this.enterTextBox4 = new WorldWind.EnterTextBox();
            ...
            // groupBoxWWSearch
            // 
            this.groupBoxWWSearch.Controls.Add(this.cbSearchInView);
            ...
            this.cbSearchInView.CheckedChanged += new System.EventHandler(this.cbSearchInView_CheckedChanged);
            // 
            // buttonWWSearch
            // 
            ...
            this.statusBar.Size = new System.Drawing.Size(799, 24);
            ...
            // tabPageWWFeature
            // 
            this.tabPageWWFeature.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(111)))), ((int)(((byte)(111)))), ((int)(((byte)(111)))));
    ...
    "ses";
            ...
            // tabPageYahoo
            // 
            this.tabPageYahoo.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(111)))), ((int)(((byte)(111)))), ((int)(((byte)(111)))));
            ...
            // tabPageVE
            // 
            this.tabPageVE.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(111)))), ((int)(((byte)(111)))), ((int)(((byte)(111)))));
            ...
            // button9
            // 
            this.button9.Location = new System.Drawing.Point(227, 58);
            ...
            // pictureBox8
            // 
            this.pictureBox8.Location = new System.Drawing.Point(390, 48);
            this.pictureBox8.Name = "pictureBox8";
            this.pictureBox8.Size = new System.Drawing.Size(72, 56);
            this.pictureBox8.TabIndex = 6;
            this.pictureBox8.TabStop = false;
            // 
            // button10
            // 
            this.button10.Location = new System.Drawing.Point(227, 58);
            ...
            // button11
            // 
            this.button11.Location = new System.Drawing.Point(227, 58);
            ...
            // pictureBox9
            // 
            this.pictureBox9.Location = new System.Drawing.Point(390, 48);
            this.pictureBox9.Name = "pictureBox9";
            this.pictureBox9.Size = new System.Drawing.Size(72, 56);
		...
		private void SearchOnline()
		{
			...
			try
			{
                ...
                if(cbSearchInView.Checked)
                {
                    Camera.CameraBase camera = m_WorldWindow.DrawArgs.WorldCamera;
                    double halfView = MathEngine.RadiansToDegrees(Math.Atan(camera.Altitude / m_WorldWindow.CurrentWorld.EquatorialRadius * Math.Tan(camera.Fov.Radians)));

                    double top = camera.Latitude.Degrees + halfView * m_WorldWindow.Height / m_WorldWindow.Width;
                    double bottom = camera.Latitude.Degrees - halfView * m_WorldWindow.Height / m_WorldWindow.Width;
                    double left = camera.Longitude.Degrees  - halfView;
                    double right = camera.Longitude.Degrees + halfView;
                    searchUriString += string.Format("&filter_bbox={0}:{1}:{2}:{3}", left.ToString(CultureInfo.InvariantCulture), bottom.ToString(CultureInfo.InvariantCulture), right.ToString(CultureInfo.InvariantCulture), top.ToString(CultureInfo.InvariantCulture));
                }
        ...
        private void cbSearchInView_CheckedChanged(object sender, EventArgs e)
        {
            lastSearchTerm = "";
        }

        private const string GoogleKey = "ABQIAAAACa4WGp5Uv52H7G0K5NI5sBTvg4F4NXNiK5VsCB5rxeWSfz3KRBROXKeNOov5-8cqJUzDuisDCCxI2Q";
        private const string GoogleUrl = "http://maps.google.com/maps/geo";
        /// <summary>
        ...
        /// <param name="e"></param>
        private void gmSearch_Click(object sender, EventArgs e)
        {
            //TODO: Parse input from EnterTextBox
            
            lastSearchTerm = "";

            string address = GMenterTextBox.Text.Trim();
            ...
            this.statusBar.BeginInvoke(new SetStatusMessageDelegate(SetStatusMessage), new object[] { "Searching Google Maps ..." });

            //TODO: Replace spaces with "+" and form a Get Request
            //Search.SearchForAddress(address, out lat1, out lon1, out lat2, out lon2);
            string request = String.Format("{0}?q={1}&output=xml&key={2}", GoogleUrl, address, GoogleKey);
            // Offline mode check
            if (World.Settings.WorkOffline)
            {
            ...
            WebDownload wd = new WebDownload(request);
            wd.DownloadMemory();
            XmlDocument doc = new XmlDocument();
            doc.Load(wd.ContentStream);
            XmlNodeList resultList = doc.GetElementsByTagName("coordinates");
            if (resultList != null && resultList.Count > 0)
            {
                String[] coords = resultList[0].InnerText.Split(',');


                double lat = Convert.ToDouble(coords[1]);
                double lon = Convert.ToDouble(coords[0]);

                //TODO: Parse XML Response and add to search results
                string[] parts = { address, Convert.ToString(lat), Convert.ToString(lon) };
                ListViewItem result = new ListViewItem(parts);
                this.statusBar.BeginInvoke(new SetStatusMessageDelegate(SetStatusMessage), new object[] { "Displaying Google Maps search result" });
                listViewResults.Items.Add(result);
            }
            else
            {
                this.statusBar.BeginInvoke(new SetStatusMessageDelegate(SetStatusMessage), new object[] { "Google Maps has no results!!" });
            }
        }
	}
