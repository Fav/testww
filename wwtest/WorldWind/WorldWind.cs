...
namespace WorldWind
{
	...
	public class MainApplication : System.Windows.Forms.Form, IGlobe
	{
		...
		// The value of Release is now set in Main()
		public static string Release;
		#endregion

		#region Paths
		// World Wind application base directory ("C:\Program Files\NASA\Worldwind v1.3\")
		public static readonly string DirectoryPath = Path.GetDirectoryName(Application.ExecutablePath);
		#endregion

		#region Dialogs, Managers and other kinds of forms
		...
		#region Window settings used when restoring from full-screen.
		private FormWindowState normalWindowState;
		private static bool startFullScreen;
		#endregion

		#region Other misc variables
		...
		//private WorldXmlDescriptor.WorldType currentWorld;
		...
		{
			// Cannot lead settings here, because this constructor may
			// be called before Main(), and the location from which to
			// load settings may not be known until after ParseArgs().
			//LoadSettings();
		}
		...
		private void InitializeComponent()
		{
            ...
            WorldWind.WorldSettings worldSettings1 = new WorldWind.WorldSettings();
            ...
            this.webBrowserPanel.Size = new System.Drawing.Size(58, 106);
            ...
            // menuItemWorkOffline
            // 
            worldSettings1.AllowNegativeAltitude = false;
            worldSettings1.AllowNegativeTilt = false;
            worldSettings1.AlwaysRenderWindow = false;
            worldSettings1.AntiAliasedText = false;
            worldSettings1.BmngVersion = 1;
            worldSettings1.BrowserOrientationHorizontal = false;
            worldSettings1.BrowserSize = 300;
            worldSettings1.BrowserVisible = false;
            worldSettings1.CameraAltitude = 20000000D;
            worldSettings1.CameraBankLock = true;
            worldSettings1.CameraDoubleClickZoomFactor = 2F;
            worldSettings1.CameraHasInertia = true;
            worldSettings1.CameraHasMomentum = false;
            worldSettings1.CameraHeadTracking = false;
            worldSettings1.CameraIsPointGoto = true;
            worldSettings1.CameraResetsAtStartup = true;
            worldSettings1.CameraRotationSpeed = 3.5F;
            worldSettings1.CameraSlerpInertia = 0.05F;
            worldSettings1.CameraSlerpStandard = 0.35F;
            worldSettings1.CameraSmooth = true;
            worldSettings1.CameraSwivelLock = true;
            worldSettings1.CameraTwistLock = true;
            worldSettings1.CameraZoomAcceleration = 10F;
            worldSettings1.CameraZoomAnalogFactor = 1F;
            worldSettings1.CameraZoomStepFactor = 0.015F;
            worldSettings1.CameraZoomStepKeyboard = 0.15F;
            worldSettings1.ConvertDownloadedImagesToDds = true;
            worldSettings1.CrosshairColor = System.Drawing.Color.FromArgb(((int)(((byte)(245)))), ((int)(((byte)(245)))), ((int)(((byte)(220)))));
            worldSettings1.CrosshairSize = 10;
            worldSettings1.DefaultFontName = "Tahoma";
            worldSettings1.DefaultFontSize = 9F;
            worldSettings1.DefaultFontStyle = System.Drawing.FontStyle.Regular;
            worldSettings1.DisplayUnits = WorldWind.Units.Metric;
            worldSettings1.DownloadLogoColor = System.Drawing.Color.FromArgb(((int)(((byte)(180)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))));
            worldSettings1.DownloadProgressColor = System.Drawing.Color.FromArgb(((int)(((byte)(50)))), ((int)(((byte)(255)))), ((int)(((byte)(0)))), ((int)(((byte)(0)))));
            worldSettings1.DownloadQueuedColor = System.Drawing.Color.FromArgb(((int)(((byte)(50)))), ((int)(((byte)(128)))), ((int)(((byte)(168)))), ((int)(((byte)(128)))));
            worldSettings1.DownloadTerrainRectangleColor = System.Drawing.Color.FromArgb(((int)(((byte)(50)))), ((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(255)))));
            worldSettings1.ElevateCameraLookatPoint = true;
            worldSettings1.EnableAtmosphericScattering = false;
            worldSettings1.EnableSunShading = false;
            worldSettings1.EquatorLineColor = System.Drawing.Color.FromArgb(((int)(((byte)(160)))), ((int)(((byte)(64)))), ((int)(((byte)(224)))), ((int)(((byte)(208)))));
            worldSettings1.FileName = null;
            worldSettings1.ForceCpuAtmosphere = true;
            worldSettings1.FormatVersion = "11.0.50727.1";
            worldSettings1.FpsFrameCount = 300;
            worldSettings1.KeepOriginalSvsImages = false;
            worldSettings1.LatLonLinesColor = System.Drawing.Color.FromArgb(((int)(((byte)(200)))), ((int)(((byte)(160)))), ((int)(((byte)(160)))), ((int)(((byte)(160)))));
            worldSettings1.LayerManagerFontName = "Tahoma";
            worldSettings1.LayerManagerFontSize = 9F;
            worldSettings1.LayerManagerFontStyle = System.Drawing.FontStyle.Regular;
            worldSettings1.LayerManagerWidth = 200;
            worldSettings1.LightColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))));
            worldSettings1.LoadedLayers = ((System.Collections.ArrayList)(resources.GetObject("worldSettings1.LoadedLayers")));
            worldSettings1.Log404Errors = false;
            worldSettings1.MaxSimultaneousDownloads = 1;
            worldSettings1.MeasureLineGroundColor = System.Drawing.Color.FromArgb(((int)(((byte)(222)))), ((int)(((byte)(0)))), ((int)(((byte)(255)))), ((int)(((byte)(0)))));
            worldSettings1.MeasureLineGroundColorXml = -570360064;
            worldSettings1.MeasureLineLinearColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(0)))), ((int)(((byte)(0)))));
            worldSettings1.MeasureLineLinearColorXml = -65536;
            worldSettings1.MeasureMode = WorldWind.MeasureMode.Single;
            worldSettings1.MeasureShowGroundTrack = false;
            worldSettings1.MenuBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(170)))), ((int)(((byte)(40)))), ((int)(((byte)(40)))), ((int)(((byte)(40)))));
            worldSettings1.MenuBarBackgroundColor = System.Drawing.Color.FromArgb(((int)(((byte)(128)))), ((int)(((byte)(128)))), ((int)(((byte)(128)))), ((int)(((byte)(128)))));
            worldSettings1.MenuOutlineColor = System.Drawing.Color.FromArgb(((int)(((byte)(150)))), ((int)(((byte)(160)))), ((int)(((byte)(160)))), ((int)(((byte)(160)))));
            worldSettings1.MinSamplesPerDegree = 3F;
            worldSettings1.ModisIconSize = 60;
            worldSettings1.ScrollbarColor = System.Drawing.Color.FromArgb(((int)(((byte)(170)))), ((int)(((byte)(100)))), ((int)(((byte)(100)))), ((int)(((byte)(100)))));
            worldSettings1.ScrollbarHotColor = System.Drawing.Color.FromArgb(((int)(((byte)(170)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))));
            worldSettings1.ShadingAmbientColor = System.Drawing.Color.FromArgb(((int)(((byte)(50)))), ((int)(((byte)(50)))), ((int)(((byte)(50)))));
            worldSettings1.ShowBoundaries = false;
            worldSettings1.ShowClouds = true;
            worldSettings1.ShowCompass = false;
            worldSettings1.ShowCrosshairs = false;
            worldSettings1.ShowDownloadIndicator = true;
            worldSettings1.ShowFpsGraph = false;
            worldSettings1.ShowLatLonLines = false;
            worldSettings1.ShowLayerManager = false;
            worldSettings1.ShowPlacenames = true;
            worldSettings1.ShowPlanetAxis = false;
            worldSettings1.ShowPosition = false;
            worldSettings1.ShowToolbar = true;
            worldSettings1.ShowTropicLines = true;
            worldSettings1.SkyColor = System.Drawing.Color.FromArgb(((int)(((byte)(115)))), ((int)(((byte)(155)))), ((int)(((byte)(185)))));
            worldSettings1.StandardAmbientColor = System.Drawing.Color.FromArgb(((int)(((byte)(64)))), ((int)(((byte)(64)))), ((int)(((byte)(64)))));
            worldSettings1.SunDistance = 150000000000D;
            worldSettings1.SunElevation = 0.78539816339744828D;
            worldSettings1.SunHeading = -0.78539816339744828D;
            worldSettings1.SunSynchedWithTime = true;
            worldSettings1.TerrainTileRetryInterval = System.TimeSpan.Parse("00:30:00");
            worldSettings1.TextureFormat = Microsoft.DirectX.Direct3D.Format.Dxt3;
            worldSettings1.ThrottleFpsHz = 50;
            worldSettings1.TimeMultiplier = 1F;
            worldSettings1.ToolbarAnchor = WorldWind.Menu.MenuAnchor.Top;
            worldSettings1.ToolBarBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(100)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))));
            worldSettings1.ToolbarFontName = "Tahoma";
            worldSettings1.ToolbarFontSize = 8F;
            worldSettings1.ToolbarFontStyle = System.Drawing.FontStyle.Bold;
            worldSettings1.TropicLinesColor = System.Drawing.Color.FromArgb(((int)(((byte)(160)))), ((int)(((byte)(176)))), ((int)(((byte)(224)))), ((int)(((byte)(230)))));
            worldSettings1.UseBelowNormalPriorityUpdateThread = false;
            worldSettings1.UseDefaultLayerStates = true;
            worldSettings1.UseInternalBrowser = true;
            worldSettings1.UseOfflineSearch = false;
            worldSettings1.UseWorldSurfaceRenderer = true;
            worldSettings1.VerticalExaggeration = 3F;
            worldSettings1.VSync = true;
            worldSettings1.WFSNameColors = WorldWind.WFSNameColors.Default;
            worldSettings1.WFSNameSizeMultiplier = 1F;
            worldSettings1.WFSOutlineText = false;
            worldSettings1.WidgetBackgroundColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(255)))));
            worldSettings1.WorkOffline = false;
            this.menuItemWorkOffline.Checked = worldSettings1.WorkOffline;
            this.menuItemWorkOffline.Index = 2;
            this.menuItemWorkOffline.Text = "Work Offline";
...
*/
		...
		#region MenuItem and Toolbar item Click methods
		// update menu with correct settings at popup
		...
		{
			// changed by Dave Mays 9/30/2004 (remove if you like - this is in lieu of CVS)
		...
		#region Script instantiation and control
		...
		#region Inter-process messaging methods
		/// <summary>
		...
		{
			foreach(string zipFilePath in ZipPath)
			{
				worldWindUri.PreserveCase = "worldwind://install=" + ZipPath;
				ProcessInstallEncodedUri();
			}
		}
		...
		{
			// TODO: Fix menu updates
			this.menuItemShowCrosshairs.Checked = World.Settings.ShowCrosshairs;
			this.menuItemShowLatLonLines.Checked = World.Settings.ShowLatLonLines;
			this.menuItemShowPosition.Checked = World.Settings.ShowPosition;
			this.menuItemLayerManager.Checked = World.Settings.ShowLayerManager;//this.worldWindow.ShowLayerManager;
			this.menuItemUseInternalBrowser.Checked = World.Settings.UseInternalBrowser;
		...
		#region Various World handling methods
		/// <summary>
